          ...
          <section className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-700 via-purple-800 to-purple-950 p-6 text-white shadow-xl shadow-purple-200/60 sm:p-8 lg:p-10">
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <button
                ...
                className="mt-6 rounded-xl bg-orange-500 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-orange-900/20 transition-all duration-200 hover:bg-orange-400 hover:shadow-xl active:scale-95"
              >
                Create Examination
              </button>
          ...
          <section className="mt-6 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-purple-100 bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 rounded-xl border border-dashed border-orange-200 bg-orange-50/40 p-6 text-center">
                ...
                <p className="mt-1 text-xs text-slate-400">
                  Student registration requests will appear
                  here.
                </p>
              ...
              <button
                ...
                className="mt-4 w-full rounded-xl border border-orange-200 px-4 py-2.5 text-sm font-semibold text-orange-600 transition hover:bg-orange-50"
              >
            ...
            <div className="rounded-2xl border border-purple-100 bg-white p-6 shadow-sm">
              ...
              <button
                ...
                className="mt-4 w-full rounded-xl border border-purple-200 px-4 py-2.5 text-sm font-semibold text-purple-700 transition hover:bg-purple-50"
              >
                Create Question Set
              </button>
